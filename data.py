...
def get_data(query):
    ...
    elif query == 'Social Activity Overview':
        return pd.read_json('https://api.flipsidecrypto.com/api/v2/queries/3fd04ee6-1d12-41e8-9fe9-98213907078c/data/latest')
    
    elif query == 'Social Activity Daily':
        return pd.read_json('https://api.flipsidecrypto.com/api/v2/queries/9a727f42-ebdf-4998-8890-9429d6b9469e/data/latest')
    
    elif query == 'Social Active Users':
        return pd.read_json('https://api.flipsidecrypto.com/api/v2/queries/0221868e-b0d9-4f0f-99c8-3a79aa2692d7/data/latest')
    
    elif query == 'Social Following Daily':
        return pd.read_json('https://api.flipsidecrypto.com/api/v2/queries/0824497f-a8c0-4869-a922-c786196398a7/data/latest')
    
    elif query == 'Social Following Counts':
        return pd.read_json('https://api.flipsidecrypto.com/api/v2/queries/6582612a-2527-4129-9770-62690e188bc5/data/latest')
    
    elif query == 'Social Widgets Overview':
        return pd.read_json('https://api.flipsidecrypto.com/api/v2/queries/b51c9aee-7c4f-43d9-b015-564f28b25545/data/latest')
    
    elif query == 'Social Widgets Daily':
        return pd.read_json('https://api.flipsidecrypto.com/api/v2/queries/204b47f7-a3dc-4b22-88d9-8742360281d9/data/latest')
    
    elif query == 'Social Widgets Creators':
        return pd.read_json('https://api.flipsidecrypto.com/api/v2/queries/04675497-866c-406e-b522-0ada2c2a44f7/data/latest')
